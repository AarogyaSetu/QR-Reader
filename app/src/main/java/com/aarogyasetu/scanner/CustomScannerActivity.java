package com.aarogyasetu.scanner;
...
public class CustomScannerActivity extends Activity implements CustomCaptureManager.CaptureViewListener {
    ...
    private TextView desc, descReason;
  ...
  /*  private void onGenerateQrClick() {
            ...
            try {
                ...
                if (body != null) {
                    ...
                    if (expiry <= 0 || TextUtils.isEmpty(mobileNo)) {
                        showInvalidStatus(Constants.EXPIRY_OR_MOBILE_FAILURE);
                        ...
                        showInvalidStatus(Constants.OTHER_DECODE_ERROR);
                    }
                } else {
                    showCommonInvalidStatus();
                }
    ...
    private void setDescriptionText(String mobileNo, String name, int message) {
        String descVal = name + " (" + mobileNo + ") " + getString(message);
    ...
    private void showPermissionAlert() {
        ...
        builder.setMessage(getString(R.string.scan_without_perm_alert))
                .setCancelable(false)
    ...
    public static Jws<Claims> decryptFile(String jwtToken) throws NoSuchAlgorithmException, InvalidKeySpecException, JwtException {
        String publicKeyString = Constants.SCANNER_PUBLIC_KEY;
